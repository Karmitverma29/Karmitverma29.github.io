...
import "./projects.css"
function Projects(){
    return <div className="projects" style={{width:"60%",height:"auto",margin:"auto",marginTop:"20px"}}>

<div  className="child" style={{border:"3px solid #ffb301",borderRadius:"10px",backgroundColor:"#ffffff"}}>
<img className="image" style={{height:"50%",width:"100%",borderRadius:"10px"}} src={`${process.env.PUBLIC_URL}/buylance.png`} alt="img"/>
<h1 className="heading" style={{fontSize:"24px",fontWeight:"600",textAlign:"center",marginTop:"10px",color:"#ffb301"}}>Buylance</h1>
<p style={{textAlign:"center",fontSize:"16px"}}>
An online one-stop fashion portal for apparel, footwear and accessories for men and women. 
</p>
...
<div className="btns" style={{height:"60px",width:"250px",margin:"auto",marginTop:"10px"}}>
    <a href="https://buylance.netlify.app/" rel="noreferrer" target="_blank">
...
<a href="https://github.com/faizal-siddiqui/murky-rate-2238" rel="noreferrer" target="_blank">
